...
- 方案版本：v0.3-R24
- 清单生成日期：2026-07-22
- 工作区基线：v0.2.14-lab.1，方案 A r0008、方案 B r0014、Salamander r0015、schema 9 r0012、Fail2ban SSH 白名单、规则刷新失败保护、Hysteria2 能力矩阵、性能基线、受管 UDP buffer、Adapter Registry 渐进接入、服务等待收口与只读带宽建议实机验收；schema 10 通用实例兼容层已完成当前 VPS 部署验收
- 说明：为避免自引用，清单不记录自身哈希；ZIP 仍包含本清单。

| 文件 | 字节数 | SHA-256 |
| --- | ---: | --- |
| `00-执行摘要与决策清单.md` | 5692 | `1a8d4882e68dd0e278da8d2c8f86682185f5102ab8be93b12a499e4bc8e343c3` |
...
| `08-版本路线图与优先级.md` | 3436 | `da32d0c65b7fe6432116dbd11213af9703b10726f5c0536945f7bb765147445a` |
...
| `12-审查记录与修订说明.md` | 9016 | `c4623ed0ccc128335dfaff004cbeddb2deed550bf3f633bf55e41f219618a398` |
| `README.md` | 3303 | `ec843634321172d5fc4e34c58b4c243b364e4d06dc9545165b9fe0174baeec95` |
| `VPSKit-完整方案-v0.3-20260720.md` | 83245 | `a6430ebf3ed294d218446f182d5de384cc3623aed56ae8d59b22581c3821d822` |
