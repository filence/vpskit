...
$code = [char]96
$baseline = "- 当前产品基线：VPSKit ${code}v0.2.5-lab.1${code}；方案 A r0008、方案 B r0014、schema 9 白名单/自定义规则 r0012、${code}doctor --fix${code}、扩展 ${code}system inspect${code}、Fail2ban SSH 白名单、规则刷新失败保护与系统更新候选检查已完成对应实机验收"
...
$stageRoot = Join-Path $projectRoot '.build\vpskit-plan-r15-package'
