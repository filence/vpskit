...
$code = [char]96
$baseline = "- 当前产品基线：VPSKit ${code}v0.2.2-lab.2${code}；方案 A r0008、${code}doctor --fix${code}、扩展 ${code}system inspect${code}、Fail2ban 与系统更新候选检查已完成对应实机验收"
...
$manifest = @(
    ...
    '- 工作区基线：v0.2.2-lab.2 受管规则缓存与 r0008 实机验收',
