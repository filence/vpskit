...
archive='/root/v0.1.0-lab.4-linux-amd64.tar.gz'
archive_sha256='1c8ef126e1f08b2585978fe67dfd53cb3b8cdf9282982f1a00948800ca71266c'
release_parent='/root/vpskit-lab-v0.1.0-lab.4'
bundle="${release_parent}/v0.1.0-lab.4"
