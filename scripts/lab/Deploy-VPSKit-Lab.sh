...
archive='/root/v0.1.0-lab.1-linux-amd64.tar.gz'
archive_sha256='f4b2defb8ae9db921a73029bbbbac404e6d7432cf33f8140d197fd9bc08ce21a'
release_parent='/root/vpskit-lab-v0.1.0-lab.1'
bundle="${release_parent}/v0.1.0-lab.1"
