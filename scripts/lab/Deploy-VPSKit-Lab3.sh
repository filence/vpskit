...
archive='/root/v0.1.0-lab.3-linux-amd64.tar.gz'
archive_sha256='28650b031b8c59f56b49770f8c69af80ce6f560aa42bd482608cbc6c26e508c4'
release_parent='/root/vpskit-lab-v0.1.0-lab.3'
bundle="${release_parent}/v0.1.0-lab.3"
