...
func managedBackupSources() []managedBackupSource {
	return []managedBackupSource{
		...
		{subscriptionConfigPath, "subscription/config.json", 0o644},
		{subscriptionSecretPath, "subscription/secrets.json", 0o600},
		{publicationStatePath, "subscription/state.json", 0o600},
